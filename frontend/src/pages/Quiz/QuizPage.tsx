...
const QuizPage = () => {
  ...
  useEffect(()=>{
    const fetchQuiz = async ()=>{
      try {
        ...
        toast.error(error.message || 'Failed to get quiz')
      }
    }
    fetchQuiz()
  }, [quizId]);
  ...
  return (
    <div className='max-w-4xl mx-auto'>
      ...
      {/* Question Card */}
      <div className='bg-white/80 backdrop-blur-xl border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8'>
            ...
            return(
              ...
              className={`group relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200
                ${isSelected ?
                  ...
                  {/*  Custom Radio */}
                  <div className={`shrink-0 w-5 h-5 rounded-full transition-all duration-200 ${
                    isSelected
      ...
      <div className='flex items-center justify-between gap-4'>
        ...
        variant='secondary'
        >
          <ChevronLeft className='w-4 h-4 hover:-translate-x-0.5 transition-transform duration-200' strokeWidth={2.5}/>
          Previous
        </Button>
        ...
        {currentQuestionIndex === quiz.questions.length -1 ? (
          ...
          >
            Next
            <ChevronRight className='w-4 h-4 hover:-translate-x-0.5 transition-transform duration-200' strokeWidth={2.5} />
          </Button>
        )}
      </div>

...
const DashboardPage = () => {
  ...
  return (
    <div className='min-h-full'>
      {/* Background Pattern - removed absolute positioning */}
      <div className='fixed inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] opacity-30 pointer-events-none -z-10' />
      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        {/* Recent Activity */}
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 md:p-8'>
                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex items-center gap-2 mb-1'>
                    ...
                    <p className='text-sm font-medium text-slate-900 truncate'>
                      ...
                      <span className='text-slate-700 ml-1'>{activity.description}</span>
                    </p>
                  </div>
